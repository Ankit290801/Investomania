...
const schema = yup.object().shape({
  name: yup.string().required('NPS account name is required'),
...
const NPSForm = ({ onSubmit, onCancel }) => {
        ...
        <Grid item xs={12}>
          <Controller
            ...
            render={({ field }) => (
              <TextField
                {...field}
                label="NPS Account Name"
                fullWidth
                required
                error={!!errors.name}
                helperText={errors.name?.message}
                placeholder="e.g., My NPS Tier-I"
              />
            )}
          />
        </Grid>
          ...
          <Controller
            ...
            render={({ field }) => (
              <TextField
                ...
                fullWidth
                required
                error={!!errors.pranNumber}
                helperText={errors.pranNumber?.message}
